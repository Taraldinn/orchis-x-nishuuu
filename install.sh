...
Run without options for interactive installation mode.

OPTIONS:
  --interactive           Launch interactive installation mode (default when no options provided)
  ...
  --auto-switch           Install automatic theme switcher that follows GNOME's dark/light preference
